...
public class LabelView extends LinearLayout {
    ...
    public LabelView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.item_camera_label, this);
    ...
    public void init(TagItem tagItem) {
        ...
        if (tagItem.getType() == POST_TYPE_POI) {
    ...
    public void draw(ViewGroup parent, final int left, final int top, boolean isLeft) {
        ...
        if (parentWidth <= 0) {
            parentWidth = DisplayUtil.getScreenWidth();
        }
    ...
    private int getImageWidth() {
        return imageWidth <= 0 ? DisplayUtil.getScreenWidth() : imageWidth;
    }
