...
import com.alex.cycling.ui.camera.adapter.StickerToolAdapter;
...
//        btn.setCompoundDrawablesWithIntrinsicBounds(null, null, null, myImage);
    ...
    private void initSticker() {
        ...
        StickerToolAdapter mAdapter = new StickerToolAdapter(EffectUtil.addonList);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setItemClickListener(new StickerToolAdapter.OnItemClickListener() {
            @Override
