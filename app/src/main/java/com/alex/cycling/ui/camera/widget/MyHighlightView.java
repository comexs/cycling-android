package com.alex.cycling.ui.camera.widget;
...
import com.alex.cycling.ui.camera.util.Point2D;
import com.alex.cycling.ui.camera.util.UIUtils;
import com.alex.cycling.ui.camera.widget.drawable.EditableDrawable;
import com.alex.cycling.ui.camera.widget.drawable.FeatherDrawable;
...
public class MyHighlightView implements EditableDrawable.OnSizeChange {
    ...
    public void setScaleable(boolean scaleable) {
        ...
        if (scaleable) {
            mAnchorRotate = CSApplication.getInstance().getResources().getDrawable(R.mipmap.aviary_resize_knob);
        } else {
            mAnchorRotate = null;
        }
    }
    ...
    public void setDeleteable(boolean deleteable) {
        if (deleteable) {
            mAnchorDelete = CSApplication.getInstance().getResources().getDrawable(R.mipmap.aviary_delete_knob);
        } else {
            mAnchorDelete = null;
        }
    }
    ...
    public void draw(final Canvas canvas) {
        ...
        if (is_selected || is_focused) {
            ...
            if (mShowAnchors) {
                ...
                outlinePaint.setStrokeWidth(DisplayUtil.dip2px(1));
